...
Optimize — vendor is needed, but cost, licensing, scope, or usage likely exceeds requirements
...
Department Assignment Guidance (Non-binding; use judgment where appropriate)
